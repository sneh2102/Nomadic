    ...
    return (
        <div className="relative w-full h-full overflow-hidden rounded-xl">
            ...
            <div className="full w-full text-white tracking-tight  p-16">
                    {props.pretitle && <div className="font-medium my-6">{props.pretitle}</div>}
                    <div className="text-4xl font-bold my-4 mb-10">{props.title}</div>
                    <Button variant="contained" size="large"><span className="py-1 px-2">Learn More</span></Button>
            </div>
        </div>
    );
};
