...
{
    question: "I’m scheduled to travel. Are we still going and when will I be notified?",
...
{
    question: "Will you run tours even if not everything is open in that country?",
